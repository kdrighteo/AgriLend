    ...
    <div className="dashboard-container">
          ...
          <div className="farmer-stats">
            <div className="stat-card">
              ...
              <p className="stat-description">
                {user?.creditScore && user.creditScore >= 70
                  ? "Excellent"
            ...
            <div className="stat-card">
              ...
              <div className="stat-value">
                {
                  loans.filter((loan) => ["repaid"].includes(loan.status))
                    .length
                }
              </div>
      ...
      <div className="dashboard-content">
        <div className="section-header">
          ...
          {loans.filter((loan) => !["rejected", "repaid"].includes(loan.status))
            .length > 0 && (
            <div className="loan-count">
              {
                loans.filter(
                  (loan) => !["rejected", "repaid"].includes(loan.status),
                ).length
              }{" "}
              active/pending
            </div>
      ...
      <div className="dashboard-content">
        ...
        {loans.filter((loan) => ["repaid", "rejected"].includes(loan.status))
          .length === 0 ? (
          <div className="dashboard-message empty-message">
            <svg
              className="message-icon"
      ...
      <div className="dashboard-content">
        <div className="section-header">
          ...
          <Link to="/profile" className="link-edit-profile">
            Edit Profile
          </Link>
        </div>
        ...
        <div className="profile-card">
          <div className="profile-info">
            ...
            <div className="info-group">
              ...
              <p className="info-value">
                {user?.farmSize
                  ? `${user.farmSize} ${user.farmSizeUnit || "acres"}`
                  : "Not provided"}
              </p>
            </div>
            <div className="info-group">
