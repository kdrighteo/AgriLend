...
const AdminDashboard: React.FC<AdminDashboardProps> = () => {
      ...
      filtered = filtered.filter(
        (loan) =>
          ...
          (loan.farmer.farmName &&
            loan.farmer.farmName.toLowerCase().includes(searchLower)) ||
  ...
  const getLoanStats = () => {
    ...
    const underReview = loans.filter(
      (loan) => loan.status === "under-review",
    ).length;
    const approved = loans.filter((loan) =>
      ["approved", "funded"].includes(loan.status),
    ).length;
      ...
      <div className="admin-header">
        <div>
          ...
          <p className="admin-subtitle">
            Manage loan applications and track lending metrics
          </p>
        </div>
      </div>
                ...
                {filteredLoans.map((loan) => (
                  <tr key={loan._id}>
                    <td className="loan-id">
                      {loan._id.substring(loan._id.length - 8)}
                    </td>
                    <td>
                      <span className="farmer-name">{loan.farmer.name}</span>
                      <span className="farmer-details">
                        {loan.farmer.farmName || "Unknown Farm"} | Score:{" "}
                        {loan.farmer.creditScore || "N/A"}
                      </span>
                    </td>
                    ...
                    <td>
                      <span
                        className={`status-badge ${getStatusBadgeClass(loan.status)}`}
                      >
              ...
              <div className="review-section">
                ...
                <div className="review-grid">
                  ...
                  <div className="review-item">
                    ...
                    <div className="review-value">
                      <span
                        className={`status-badge ${getStatusBadgeClass(selectedLoan.status)}`}
                      >
                  ...
                  <div className="review-item">
                    ...
                    <div className="review-value">
                      {formatDate(selectedLoan.submittedAt)}
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="review-section">
                ...
                <div className="review-grid">
                  <div className="review-item">
                    ...
                    <div className="review-value">
                      {selectedLoan.farmer.name}
                    </div>
                  </div>
                  <div className="review-item">
                    <div className="review-label">Email</div>
                    <div className="review-value">
                      {selectedLoan.farmer.email}
                    </div>
                  </div>
                  <div className="review-item">
                    <div className="review-label">Farm Name</div>
                    <div className="review-value">
                      {selectedLoan.farmer.farmName || "Not provided"}
                    </div>
                  </div>
                  <div className="review-item">
                    <div className="review-label">Credit Score</div>
                    <div className="review-value farmer-score">
                      {selectedLoan.farmer.creditScore || "N/A"}
                    </div>
                  </div>
                </div>
              </div>
