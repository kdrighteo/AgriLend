...
const LoanApplication: React.FC = () => {
  ...
  >({});
  const [touchedFields, setTouchedFields] = useState<Set<keyof LoanFormData>>(
    new Set(),
  );
  ...
  const handleChange = (
    ...
    if (fieldErrors[name as keyof LoanFormData]) {
      setFieldErrors((prev) => ({ ...prev, [name]: undefined }));
    }
  };

  // Handle field blur for validation
  const handleBlur = (fieldName: keyof LoanFormData) => {
  ...
  const validateField = (
    ...
    switch (fieldName) {
      case "amount":
        ...
        if (isNaN(amount) || amount < 100) return "Minimum loan amount is $100";
        if (amount > 1000000) return "Maximum loan amount is $1,000,000";
        return undefined;
      case "purpose":
      ...
      case "termLength":
        ...
        if (isNaN(term) || term < 1) return "Term must be at least 1";
        if (term > 120) return "Term cannot exceed 120 months";
        return undefined;
      case "cropType":
  ...
  const validateForm = (): boolean => {
    ...
    if (currentStep === 1) {
      const step1Fields: (keyof LoanFormData)[] = [
        "amount",
        "purpose",
        "description",
        "termLength",
      ...
      const step2Fields: (keyof LoanFormData)[] = ["cropType"];
    ...
    try {
      ...
      const loanData = {
        ...
        estimatedYield: formData.estimatedYield
          ? parseFloat(formData.estimatedYield)
          : undefined,
  ...
  const getEligibilityStatus = () => {
    ...
    if (creditScore >= 70) {
      ...
      return {
        status: "medium",
        message: "Moderate eligibility for loan approval",
      };
    } else {
      return {
        status: "poor",
        message: "Limited eligibility for loan approval",
      };
    }
  };
        ...
        <div className="loan-form-card">
          <div className="loan-success">
            ...
            <p className="success-message">
              Your loan application has been successfully submitted and is now
              pending review. You will be notified once there is an update on
              your application.
            </p>
            ...
            <div className="success-details">
              <div className="detail-row">
                ...
                <span className="detail-value application-id">
                  {submittedLoan._id}
                </span>
              </div>
              <div className="detail-row">
                ...
                <span className="detail-value">
                  ${submittedLoan.amount.toLocaleString()}
                </span>
              </div>
              <div className="detail-row">
              ...
              <div className="detail-row">
                ...
                <span className="detail-value">
                  {submittedLoan.status.charAt(0).toUpperCase() +
                    submittedLoan.status.slice(1)}
                </span>
              </div>
              <div className="detail-row">
                <span className="detail-label">Date Submitted</span>
                <span className="detail-value">
                  {formatDate(submittedLoan.submittedAt)}
                </span>
              </div>
            </div>
    ...
    <div className="loan-container">
      <div className="loan-header">
        ...
        <p className="loan-subtitle">
          Fill out the form below to apply for a loan for your farming needs
        </p>
      </div>
          ...
          <div className="loan-form-card">
            <div className="form-section">
              ...
              <div className="form-group">
                ...
                {!fieldErrors.amount && (
                  <small className="form-hint">
                    Minimum loan amount is $100, maximum is $1,000,000
                  </small>
                )}
              </div>
              ...
              <div className="form-group">
                ...
                {!fieldErrors.purpose && (
                  <small className="form-hint">
                    Be specific about how you'll use the funds (e.g., "Purchase
                    tractor for corn planting season")
                  </small>
                )}
              </div>
              ...
              <div className="form-group">
                ...
                {!fieldErrors.description && (
                  <small className="form-hint">
                    Describe your farming operation, how the loan will help, and
                    expected outcomes (minimum 20 characters)
                  </small>
                )}
              </div>
              ...
              <div className="form-row">
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    onBlur={() => handleBlur("termLength")}
                    min="1"
                    required
                    className={`form-input ${fieldErrors.termLength ? "input-error" : ""}`}
                  />
                ...
                <div className="form-group">
                  <label htmlFor="termUnit" className="form-label">
                    Term Unit
                  </label>
                  <select
                    id="termUnit"
              ...
              <div className="form-group">
                <label htmlFor="collateral" className="form-label">
                  Collateral (if any)
                </label>
                <input
                  type="text"
                ...
                />
                <small className="form-hint">
                  Providing collateral may increase your chances of loan
                  approval
                </small>
              </div>
            </div>
            ...
            <div className="form-section">
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  required
                  className={`form-input ${fieldErrors.cropType ? "input-error" : ""}`}
                ...
                {!fieldErrors.cropType && (
                  <small className="form-hint">
                    Specify the primary crop this loan will support
                  </small>
                )}
              </div>

              <div className="form-group">
                <label htmlFor="farmingCycle" className="form-label">
                  Farming Cycle*
                </label>
                <select
                  id="farmingCycle"
              ...
              <div className="form-row">
                <div className="form-group">
                  <label htmlFor="estimatedRevenue" className="form-label">
                ...
                <div className="form-group">
                  <label htmlFor="revenueUnit" className="form-label">
            ...
            <div className="form-section">
              ...
              <div className="credit-score-info">
                <div>
                  ...
                  <div
                    className={`eligibility-message eligibility-${eligibility.status}`}
                  >
                    {eligibility.message}
                  </div>
                </div>
              ...
              <div className="review-section">
                ...
                <div className="detail-row">
                  ...
                  <span className="detail-value">
                    {formData.termLength} {formData.termUnit}
                  </span>
                </div>
                <div className="detail-row">
              ...
              <div className="review-section">
                ...
                <div className="detail-row">
                  ...
                  <span className="detail-value">
                    {formData.farmingCycle.charAt(0).toUpperCase() +
                      formData.farmingCycle.slice(1)}
                  </span>
                </div>
                {formData.estimatedYield && (
                  <div className="detail-row">
                    ...
                    <span className="detail-value">
                      {formData.estimatedYield} tons/bushels
                    </span>
                  </div>
                )}
                {formData.estimatedRevenue && (
                  <div className="detail-row">
                    ...
                    <span className="detail-value">
                      ...
                      {formData.revenueUnit !== "total" &&
                        ` (${formData.revenueUnit})`}
                    </span>
                  </div>
                )}
              </div>
